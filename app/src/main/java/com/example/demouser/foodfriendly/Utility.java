...
/**
 * Created by Awesome Engineer on 31/07/2014.
 */
public class Utility {

    public static final String LACTOSE_STATE = "lactose_state";
    public static final String  GLUTEN_STATE = "gluten_state";
    ...
    public static final String MAP_FRAG = "map_fragment";
